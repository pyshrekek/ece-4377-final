...
PACKAGE BODY RENDERING_PIPELINE IS
    ...
    BEGIN
        ...
        depth_x := cube.side_length / 3;
        depth_y := -cube.side_length / 4;

        f0_x := cube.center_x - half_side;
        f0_y := cube.center_y - half_side;
        f1_x := cube.center_x + half_side;
        f1_y := cube.center_y - half_side;
        f2_x := cube.center_x + half_side;
        f2_y := cube.center_y + half_side;
        f3_x := cube.center_x - half_side;
        f3_y := cube.center_y + half_side;
        ...
        visible_face_triangles(0) := (
            ...
            normal_x_q8 => 0, normal_y_q8 => 0, normal_z_q8 => 256
        );
        ...
        visible_face_triangles(2) := (
            ...
            normal_x_q8 => 256, normal_y_q8 => 0, normal_z_q8 => 0
        );
        ...
        visible_face_triangles(4) := (
            ...
            normal_x_q8 => 0, normal_y_q8 => 256, normal_z_q8 => 0
        );
